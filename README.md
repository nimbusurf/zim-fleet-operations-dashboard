...
```text
zim-fleet-operations-dashboard/
│
├── docker-compose.yml          # Spins up PostgreSQL + Flask + React
...
│   ├── nginx.conf              # Reverse proxy to Flask API
│   ├── src/
│   │   ├── components/         # Reusable components: Layout, DataTable, StatusBadge, Charts
│   │   ├── pages/              # Route views: Dashboard, Fleet, Maintenance, etc.
...
│       ├── models/             # Database models: Vehicle, Asset, Ticket, etc.
│       ├── routes/             # API blueprints: fleet, maintenance, assets, etc.
│       ├── services/           # Business logic layer
│       └── utils/              # Seed data and validators
│
└── database/
    └── init/
